...
# [assignment] create your own bash script to compile _plonkMultiplier3.circom using PLONK below
...
snarkjs zkey export verificationkey _plonkMultiplier3/circuit_final.zkey Multiplier3/verification_key.json
